...
interface BookingCalendarProps {
  ...
  duration: number;
  // Service pre-computes these using the visitor's timezone (from cookie)
      ...
      <CardContent className="relative p-0 md:pr-64">
        <div className="p-6">
          <Calendar
            ...
            modifiersClassNames={{
              available:
                "bg-green-50 text-green-700 font-semibold hover:bg-green-100 dark:bg-green-900/30 dark:text-green-300",
            }}
          />
        </div>
        ...
        {/* Time slots panel */}
        {/* <div> */}
        <div className="md:absolute inset-y-0 right-0 flex max-h-80 w-full flex-col border-t p-4 md:max-h-none md:w-64 md:border-l md:overflow-y-auto">
          {!date ? (
            ...
            <div className="flex h-full items-center justify-center text-center text-sm text-slate-500 p-4">
              <p>
                No avaialable times for this date. Please select another day.
              </p>
            </div>
          ) : (
            <div className="space-y-2">
              <p className="text-sm font-medium text-slate-700 dark:text-slate-300 mb-3">
                {format(date, "EEE, MM d")}
              </p>
