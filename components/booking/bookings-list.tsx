...
export function BookingsList({ bookings }: BookingsListProps) {
  ...
  // Show upcoming confirmed bookings
                ...
                <CardContent className="p-0">
                  <div className="flex flex-col md:flex-row">
                    ...
                    >
                      ...
                      {" | "}
                      {isTodayBooking && (
                        <span className="mt-2 text-xs font-medium text-green-600 bg-green-100 px-2 py-0.5 rounded-full">
                          Today
                        </span>
                      )}
                    </div>
